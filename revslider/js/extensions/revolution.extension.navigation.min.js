    ...
    jQuery.extend(!0, t, {
        ...
        createNavigation: function(t, a) {
            ...
            r(t, a), s(t, a), m && f(t, o, a), a.li.each(function() {
                ...
                n.hasClass("tp-museover") || (n.addClass("tp-moseover"), punchgs.TweenLite.killDelayedCallsTo(c), m && o.hide_onleave && c(n.find(".tparrows"), o, "show"), w && p.hide_onleave && c(n.find(".tp-bullets"), p, "show"), x && g.hide_onleave && c(n.find(".tp-thumbs"), g, "show"), y && v.hide_onleave && c(n.find(".tp-tabs"), v, "show"), e && (n.removeClass("tp-mouseover"), u(t, a)))
